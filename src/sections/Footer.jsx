  ...
  return (
    ...
    <footer className="max-container ">
            ...
            <div key={section} className="">
              ...
              <ul>
                {section.links.map((link) => (
                  <li className="text-white mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-slate-gray cursor-pointer" key={link.name}>
                    <a>{link.name}</a>
                  </li>
                ))}
              </ul>
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
        ...
        <p className="cursor-pointer font-palanquin">Terms & Conditions</p>
      </div>
    </footer>
    </>
  )
